...
IF OBJECT_ID ( 'CurrencyCursor', 'P' ) IS NOT NULL
    DROP PROCEDURE CurrencyCursor
GO

CREATE PROCEDURE CurrencyCursor @CurrencyCursorVar CURSOR VARYING OUTPUT
AS
    SET NOCOUNT ON
    SET @CurrencyCursorVar = CURSOR
    FORWARD_ONLY STATIC FOR
     
	SELECT StreetName, StreetRank FROM Street
    OPEN @CurrencyCursorVar
GO


DECLARE @MyCursor CURSOR
EXEC CurrencyCursor @CurrencyCursorVar = @MyCursor OUTPUT;
